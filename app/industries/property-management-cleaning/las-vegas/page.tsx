...
export const metadata: Metadata = {
  title: { absolute: 'Property Management Cleaning in Las Vegas, NV | Final Touch' },
  description:
    'Final Touch provides unit turn cleaning, common area programs, and portfolio cleaning for property managers across the Las Vegas Valley. Call (702) 444-5077.',
  alternates: {
    canonical: `${SITE.url}/industries/property-management-cleaning/las-vegas`,
  },
  openGraph: {
    title: 'Property Management Cleaning in Las Vegas, NV | Final Touch Cleaning',
    description:
      'Final Touch provides unit turn cleaning, common area programs, and portfolio cleaning for property managers across the Las Vegas Valley. Call (702) 444-5077.',
    type: 'website',
    url: `${SITE.url}/industries/property-management-cleaning/las-vegas`,
  },
};
      ...
      <section className="bg-light-gray">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <SectionHeader
            ...
            heading="Property management cleaning across Las Vegas and the Las Vegas Valley."
          />
