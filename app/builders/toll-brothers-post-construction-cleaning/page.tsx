...
export const metadata: Metadata = {
  ...
  description:
    'Post-construction cleanup after your Toll Brothers home handoff in Las Vegas, NV. Detail-focused, Las Vegas Valley local. Call (702) 444-5077.',
  alternates: {
