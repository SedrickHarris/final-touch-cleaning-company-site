...
export const metadata: Metadata = {
  ...
  description:
    'Post-construction cleanup after your D.R. Horton or Express Homes handoff in Las Vegas, NV. Detail-focused, Las Vegas Valley local. Call (702) 444-5077.',
  alternates: {
    canonical: `${SITE.url}/builders/dr-horton-post-construction-cleaning`,
  },
  openGraph: {
    ...
    description:
      'Post-construction cleanup after your D.R. Horton or Express Homes handoff in Las Vegas, NV. Detail-focused, Las Vegas Valley local. Call (702) 444-5077.',
    type: 'website',
    url: `${SITE.url}/builders/dr-horton-post-construction-cleaning`,
  },
};

const faq = [
  {
    q: 'What does post-construction cleaning include after a D.R. Horton home in Las Vegas?',
    a: `After a D.R. Horton handoff, post-construction cleanup addresses the residue that builder cleaning does not remove: drywall dust on every surface including vents, HVAC returns, and cabinet interiors; adhesive and caulk residue around fixtures and tile; window film on all glass; construction debris from trim and baseboard work; and fine particulate that settles in corners and on sills. Scope is confirmed during a walkthrough before the clean begins.`,
  },
  {
    q: 'Do D.R. Horton Express Homes need post-construction cleaning before move-in?',
    a: `Yes. Express Homes are built to a production schedule that prioritizes move-in speed, which makes a thorough post-construction clean especially valuable. The construction residue in an Express Homes build is the same as any other new home: drywall dust, adhesive, window film, and fine grit. Many Express Homes buyers are first-time homeowners moving in quickly, and a professional cleanup ensures the home is genuinely ready before furniture and belongings arrive.`,
  },
  {
    q: 'How long after a D.R. Horton handoff should I schedule post-construction cleaning?',
    a: `Schedule as close to the handoff date as possible, before furnishings or personal items are moved in. An empty home is significantly easier to clean thoroughly at the detail level. If your move-in date is firm, call ${SITE.phone.display} in advance so Final Touch can align the clean with your schedule. Most post-construction cleans on a D.R. Horton home are completed in a single visit.`,
  },
  {
    q: "What is the difference between D.R. Horton's builder cleaning and a professional post-construction clean?",
    a: `Builder cleaning prepares a home for the final walkthrough. It addresses visible surfaces and gives the home a presentation-ready appearance. Professional post-construction cleaning addresses what remains after the builder crew leaves: drywall dust in HVAC registers and cabinet interiors, adhesive residue around tile and fixtures, window film on all glass, and fine grit on floors and baseboards. These are not visible deficiencies during a walkthrough but become apparent once the home is occupied.`,
  },
  {
    q: 'What North Las Vegas and Las Vegas Valley communities does Final Touch serve for D.R. Horton post-construction cleaning?',
    a: `Final Touch serves post-construction cleanup across ${SITE.serviceArea.county}, Nevada, including North Las Vegas, Las Vegas, and Henderson. D.R. Horton builds throughout the Las Vegas Valley with a strong concentration in North Las Vegas communities. Call ${SITE.phone.display} to confirm coverage for your specific community and address.`,
  },
];
...
const audienceItems = [
  {
    ...
    body: "D.R. Horton and Express Homes serve a significant number of first-time buyers in the Las Vegas Valley. For many, this is their first new build. A professional post-construction clean ensures the home is genuinely move-in ready before furniture and family arrive.",
  },
  {
  ...
  },
  {
    ...
    body: 'Agents and buyer representatives guiding clients through new D.R. Horton purchases who recommend a professional post-construction clean as part of the closing process.',
  },
];
...
const serviceJsonLd = {
  ...
  '@type': 'Service',
  name: 'D.R. Horton Post-Construction Cleanup',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'D.R. Horton Post-Construction Cleaning',
      item: `${SITE.url}/builders/dr-horton-post-construction-cleaning`,
    },
  ],
};

export default function DRHortonPostConstructionPage() {
  return (
    <>
      {/* JSON-LD */}
      <script
      ...
      <section className="bg-brand-white border-b border-border-subtle">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <p className="text-base sm:text-lg text-brand-black leading-relaxed">
            ...
            for D.R. Horton homebuyers and project teams across North Las Vegas,
            Las Vegas, and Henderson. After a builder handoff, every surface holds
            construction residue that standard cleaning cannot address: drywall dust
            in vents and cabinet interiors, adhesive and caulk around fixtures, window
            film on every pane of glass, and fine particulate in every corner. We scope
            the clean against the actual site before quoting. The goal is a home that
            is genuinely ready to move into, not just visually checked.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="mt-10 space-y-6 text-base text-brand-black leading-relaxed">
            <p>
              ...
              D.R. Horton follows the same handoff practice across its standard and Express Homes
              communities, and the residue left behind is consistent with any new residential build.
            </p>
            <p>
      ...
      <section className="bg-light-gray">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <SectionHeader
            ...
            heading="Who schedules post-construction cleaning after a D.R. Horton build."
          />
      ...
      <section className="bg-brand-white border-y border-border-subtle">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <SectionHeader
            ...
            sub="Final Touch serves D.R. Horton and Express Homes communities throughout the Las Vegas Valley, with a strong presence in North Las Vegas."
          />
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            {BUILDERS.filter((b) => b.href !== '/builders/dr-horton-post-construction-cleaning').map((b) => (
              <Link
                key={b.href}
                href={b.href}
                className="inline-flex items-center rounded-full border border-border-subtle bg-light-gray min-h-[44px] px-4 py-2 text-sm font-semibold text-brand-black hover:border-brand-blue/40 hover:text-brand-blue transition-colors"
      ...
      {/* 8. Final CTA */}
      <CTASection
        heading="Ready to schedule your D.R. Horton post-construction clean?"
