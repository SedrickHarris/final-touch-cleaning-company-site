...
export const metadata: Metadata = {
  title: 'Sunrise Manor Cleaning Services | Las Vegas, NV | Final Touch',
  description:
    'Family-owned commercial, office, and home cleaning in Sunrise Manor, Las Vegas, NV. Janitorial, deep, and move-out cleaning. Free quotes. Call (702) 444-5077.',
  alternates: { canonical: '/locations/las-vegas/sunrise-manor' },
  openGraph: {
    title: 'Sunrise Manor Cleaning Services | Las Vegas, NV | Final Touch Cleaning Company',
    description:
      'Scott & Nicole Maland serve Sunrise Manor and the east Las Vegas Valley. Commercial, janitorial, deep, and move-out cleaning. Free quotes across Clark County.',
    type: 'website',
...
const localBusinessJsonLd = {
  ...
  description:
    'Family-owned cleaning company serving Sunrise Manor, Las Vegas, and Clark County, NV.',
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Sunrise Manor',
      item: `${SITE.url}/locations/las-vegas/sunrise-manor`,
    },
  ],
};
  ...
  return (
    <>
      ...
      <section className="bg-brand-white">
        <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10 xl:px-12 py-16 sm:py-20 lg:py-24">
          <SectionHeader
            ...
            heading="Popular cleaning services in Sunrise Manor."
      ...
      <section className="bg-light-gray">
        <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10 xl:px-12 py-16 sm:py-20 lg:py-24">
          <SectionHeader
            ...
            heading="Why Sunrise Manor businesses and families choose Final Touch."
          />
      ...
      <CTASection
        ...
        sub="Request a free quote or call our team today. We serve Sunrise Manor and all of Clark County."
