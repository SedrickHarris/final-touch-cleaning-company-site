...
export const metadata: Metadata = {
  title: 'Spring Valley Cleaning Services | Las Vegas, NV | Final Touch',
  description:
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Spring Valley',
      item: `${SITE.url}/locations/las-vegas/spring-valley`,
    },
  ],
};
...
export default function SpringValleyPage() {
  return (
    <>
      ...
      {/* TODO-PHOTO: wire hero image when public/images/locations/spring-valley-*.webp exists */}
      <HeroSection
      ...
      <section className="bg-light-gray">
        <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10 xl:px-12 py-16 sm:py-20 lg:py-24">
          <SectionHeader
            ...
            heading="Why Spring Valley businesses and families choose Final Touch."
          />
