...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Move-In Cleaning', item: `${SITE.url}/services/move-in-cleaning` },
    { '@type': 'ListItem', position: 4, name: 'North Las Vegas', item: `${SITE.url}/services/move-in-cleaning/north-las-vegas` },
  ],
};
